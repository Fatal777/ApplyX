  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "roll-in": {
          "0%": { transform: "rotate(-10deg) translateX(-100%)", opacity: "0" },
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(160 56% 56% / 0.4)" },
          "50%": { boxShadow: "0 0 40px hsl(160 56% 56% / 0.8)" },
        },
        "shimmer": {
      ...
      animation: {
        ...
        "roll-in": "roll-in 0.8s cubic-bezier(0.4, 0, 0.2, 1)",
